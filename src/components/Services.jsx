...
const services = [
  {
    icon: (
      <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
        <path d="M4 16L18 4L32 16V32H24V22H12V32H4V16Z" stroke="#c18c3b" strokeWidth="2.5" fill="none" strokeLinejoin="round"/>
        <rect x="15" y="22" width="6" height="10" rx="1" fill="#c18c3b" opacity="0.4"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
        <rect x="3" y="10" width="30" height="22" rx="2" stroke="#c18c3b" strokeWidth="2.5" fill="none"/>
        <rect x="9" y="4" width="18" height="8" rx="2" stroke="#c18c3b" strokeWidth="2.5" fill="none"/>
        <line x1="10" y1="20" x2="10" y2="26" stroke="#c18c3b" strokeWidth="2"/>
        <line x1="18" y1="20" x2="18" y2="26" stroke="#c18c3b" strokeWidth="2"/>
        <line x1="26" y1="20" x2="26" y2="26" stroke="#c18c3b" strokeWidth="2"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
        <path d="M18 3L6 10V28L18 33L30 28V10L18 3Z" stroke="#c18c3b" strokeWidth="2.5" fill="none" strokeLinejoin="round"/>
        <circle cx="18" cy="18" r="5" fill="#c18c3b" opacity="0.5"/>
        <circle cx="18" cy="18" r="2" fill="#c18c3b"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
        <circle cx="18" cy="15" r="8" stroke="#c18c3b" strokeWidth="2.5" fill="none"/>
        <path d="M11 29C11 25.7 14.1 23 18 23C21.9 23 25 25.7 25 29" stroke="#c18c3b" strokeWidth="2.5" strokeLinecap="round"/>
        <path d="M24 11L32 8M24 14H32M24 17L32 20" stroke="#c18c3b" strokeWidth="2" strokeLinecap="round"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
        <rect x="5" y="5" width="26" height="26" rx="3" stroke="#c18c3b" strokeWidth="2.5" fill="none"/>
        <path d="M5 14H31" stroke="#c18c3b" strokeWidth="2"/>
        <path d="M14 5V14" stroke="#c18c3b" strokeWidth="2"/>
        <circle cx="22" cy="23" r="4" fill="#c18c3b" opacity="0.4"/>
        <path d="M20.5 23L22 24.5L24.5 21.5" stroke="#c18c3b" strokeWidth="1.5" strokeLinecap="round"/>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
        <path d="M8 28L12 24M28 8L24 12M12 24C9.8 21.8 9.8 18.2 12 16L20 8C22.2 5.8 25.8 5.8 28 8C30.2 10.2 30.2 13.8 28 16L20 24C17.8 26.2 14.2 26.2 12 24Z" stroke="#c18c3b" strokeWidth="2.5" strokeLinecap="round"/>
      </svg>
    ),
...
export default function Services() {
  ...
  return (
    <section id="services" className="py-19 bg-gray-50/60">
          ...
          {services.map((s, i) => (
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                {/* Badge */}
                <div className="absolute top-4 right-4 bg-navy-700 text-[#c18c3b] text-[10px] font-bold tracking-widest uppercase px-2.5 py-1 rounded-full">
                  {s.badge}
                </div>
              </div>
              ...
              <div className="p-7 pt-0 relative">
                  ...
                  {s.features.map((f) => (
                    <li key={f} className="flex items-center gap-2 text-sm text-navy-600">
                      <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                        <circle cx="7" cy="7" r="6" fill="#c18c3b" opacity="0.15"/>
                        <path d="M4.5 7L6.2 8.7L9.5 5.5" stroke="#c18c3b" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                      {f}
                    </li>
                  ))}
                ...
                <motion.div
                  ...
                  className="mt-5 flex items-center gap-2 text-[#c18c3b] text-sm font-semibold"
                >
                  Learn More
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path d="M3 8H13M10 5L13 8L10 11" stroke="#c18c3b" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </motion.div>
              </div>
            </motion.div>
