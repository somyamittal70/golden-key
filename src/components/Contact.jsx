...
const contactInfo = [
  ...
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <rect x="3" y="5" width="16" height="12" rx="2" stroke="#c18c3b" strokeWidth="1.8" fill="none"/>
        <path d="M3 8L11 13L19 8" stroke="#c18c3b" strokeWidth="1.8" strokeLinecap="round"/>
      </svg>
    ),
    label: "Email",
  ...
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <path d="M11 2C7.7 2 5 4.7 5 8C5 12.5 11 20 11 20C11 20 17 12.5 17 8C17 4.7 14.3 2 11 2Z" stroke="#c18c3b" strokeWidth="1.8" fill="none"/>
        <circle cx="11" cy="8" r="2.5" stroke="#c18c3b" strokeWidth="1.8" fill="none"/>
      </svg>
    ),
              ...
              <div className="flex gap-3">
                ...
                <a href="#" className="w-10 h-10 rounded-xl bg-navy-700/5 hover:bg-navy-700 flex items-center justify-center group transition-colors duration-300">
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                    ...
                    <circle cx="13" cy="5" r="1" fill="#032b53" className="group-hover:fill-white transition-colors"/>
                  </svg>
                </a>
                {/* LinkedIn */}
                <a href="#" className="w-10 h-10 rounded-xl bg-navy-700/5 hover:bg-navy-700 flex items-center justify-center group transition-colors duration-300">
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                    ...
                    <path d="M8.5 13V10C8.5 8.9 9.4 8 10.5 8H11C12.1 8 13 8.9 13 10V13" stroke="#032b53" strokeWidth="1.8" strokeLinecap="round" className="group-hover:stroke-white transition-colors"/>
                    <path d="M8.5 8V13" stroke="#032b53" strokeWidth="1.8" strokeLinecap="round" className="group-hover:stroke-white transition-colors"/>
                  </svg>
                </a>
                {/* YouTube */}
                <a href="#" className="w-10 h-10 rounded-xl bg-navy-700/5 hover:bg-navy-700 flex items-center justify-center group transition-colors duration-300">
            ...
            <div className="bg-gray-50/80 rounded-2xl p-8 border border-gray-100">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-navy-700 hover:bg-[#c18c3b] text-white font-semibold py-4 rounded-lg transition-all duration-300 text-sm tracking-wide"
                  >
